...
```{r echo=FALSE}
plot(Tukey_results, 
     main = "Figure 7. Family-wise Confidence Level By SES Levels", 
     xlab = "Difference in Mean Science Scores by SES Level",
     ylab = "SES Levels")
#mtext("Figure 7. Family-wise Confidence Level by SES Levels", 3, 1)
#mtext("Difference in Mean Science Scores by SES Level", 1, 3)
#mtext("SES Levels", 2, 2)
```
